...
const val DW_AT_strx_base = 0x72
const val DW_AT_dwo_name = 0x76
const val DW_AT_dwo_id = 0x78
...
const val DW_AT_decl_line = 0x39
const val DW_AT_decl_column = 0x3b
const val DW_AT_inline = 0x20
const val DW_AT_segment = 0x60

// Children flag
const val DW_CHILDREN_no = 0
const val DW_CHILDREN_yes = 1
...
// .debug_ranges v4
const val DW_RANGES_END = 0L
const val DW_RANGES_BASE_ADDRESSX32 = -1L // max u32 marker
const val DW_RANGES_BASE_ADDRESSX64 = -1L
...
const val DW_LNS_set_epilogue_begin = 0x0b
const val DW_LNS_set_isa = 0x0c

// Line extended opcodes
const val DW_LINE_end_sequence = 0x01
const val DW_LINE_set_address = 0x02
const val DW_LINE_define_file = 0x03
const val DW_LINE_set_discriminator = 0x04

val RANGE_TAGS = setOf(
    DW_TAG_subprogram, DW_TAG_inlined_subroutine, DW_TAG_lexical_block,
    DW_TAG_compile_unit, DW_TAG_skeleton_unit, DW_TAG_partial_unit, DW_TAG_type_unit
)
