...
/** DWARF 常量；值来自 DWARF4/5 规范及 LLVM BinaryFormat 头文件核对。 */
object Dw {
    const val TAG_COMPILE_UNIT = 0x11
    const val TAG_PARTIAL_UNIT = 0x03
    ...
    const val AT_COMP_DIR_OLD = 0x1b
    ...
    const val AT_STRLP_OFFSETS_HDR_GNU = 0x2132
