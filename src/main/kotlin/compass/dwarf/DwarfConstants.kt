...
object DW {
    ...
    const val FORM_strx1 = 0x1a
    const val FORM_strx2 = 0x1b
    const val FORM_strx3 = 0x1c
    const val FORM_strx4 = 0x1d
    const val FORM_strx_sup = 0x1e
    const val FORM_addrx = 0x1f
    const val FORM_addrx1 = 0x1f
    const val FORM_addrx2 = 0x20
    const val FORM_addrx3 = 0x21
    const val FORM_addrx4 = 0x22
    const val FORM_ref_sup4 = 0x23
    const val FORM_strp_sup = 0x24
    const val FORM_data16 = 0x25
    const val FORM_line_strp = 0x26
    const val FORM_ref_sig8 = 0x27
    const val FORM_implicit_const = 0x21
    const val FORM_loclistx = 0x2200
    const val FORM_rnglistx = 0x23
    const val FORM_ref_sup8 = 0x28
