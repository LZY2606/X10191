...
object Dw {
    ...
    const val TAG_entry_point = 0x14
    const val TAG_catch_block = 0x25
    const val TAG_try_block = 0x24
    const val TAG_namespace = 0x39
    const val TAG_class_type = 0x02
    const val TAG_structure_type = 0x13
    const val TAG_union_type = 0x17
    ...
    const val AT_loclists_base = 0x8c
    ...
    // v5
    const val LNE_set_file = 0x00 // placeholder, actual 0x00 with content codes below
    const val LNE_set_discriminator_v5 = 0x04

    // v5 rangelist entries
